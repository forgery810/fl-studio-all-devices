...
- Script will function with the config_layout.py code if user_layout.json is empty
...
The second file is user_layout.json. This file should be empty when downloaded. The layout data generated by the web app listed above, should be placed in the folder, replacing the empty file in the repository. 
